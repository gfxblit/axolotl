# original: https://gist.github.com/mlabonne/a3542b0519708b8871d0703c938bba9f
# Example usage:
...
def main():
    ...
    print(f"[4/5] Saving model and tokenizer in {args.hub_id or args.local_path}")
    model.save_pretrained(f"{args.hub_id or args.local_path}")
    tokenizer.save_pretrained(f"{args.hub_id or args.local_path}")
